		...
		<form id="modify_form" action="modify.do" method="post">
			...
			<ul>
				<li><label for="title">제목</label> <input type="text"
					name="title" value="${boardVO.title}" id="title" size="10" maxlength="50"></li>
				<li><label for="name">이름</label> <input type="text" name="name" value="${boardVO.name}"
					id="name" size="10" maxlength="10"></li>
				...
				<li><label for="email">이메일</label> <input type="email"
					name="email" value="${boardVO.email}" id="email" size="20" maxlength="50"></li>
				<li><label for="content">내용</label> <textarea rows="5"
						cols="40" name="content" id="content">${boardVO.content}</textarea></li>
			</ul>
