	...
	<form id="write_form" action="write.do" method="post" enctype="multipart/form-data">
		<ul>
			<li>
				...
				<input type="text" name="title" id="title" class="input-check" size="30" maxlength="50">
			</li>
			<li>
				<label for="writer">작성자</label>
				<input type="text" name="writer" id="writer" class="input-check" size="10" maxlength="10">
			</li>
			<li>
			...
			<li>
				...
				<input type="email" name="email" id="email" class="input-check" size="30" maxlength="50">
			</li>
			<li>
